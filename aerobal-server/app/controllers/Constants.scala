...
object Constants {
	...
	val EXPERIMENT_SELF_ID_TEXT = "id";
	...
	val MEASUREMENT_SELF_ID = "id";

	val AUTH_USER_TEXT = "user";
	val AUTH_PASSWORD_TEXT = "password";
	
	val AUTH_INCORRECT_PASSWORD_TEXT = "INCORRECTPASSWORD";
	val AUTH_USER_NOT_FOUND_TEXT = "NOTFOUND";
